                ...
                <div class="right_col" role="main">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12" id="Vanish">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane" id="Post_Note">
                                            ...
                                            <form id="note-form"  name="search" method="post" class="form-horizontal form-label-left" enctype="multipart/form-data">
                                                ...
                                                <input type="hidden" name="n.createdById" id="createdById" value="<s:property value="currGroup.createdBy"/>">
                                        ...
                                        <div class="tab-pane" id="Start_Video">
                                            ...
                                            <div style="margin-left: 8%">
                                                <br>
                                                <label class="col-xs-0.5 control-label">Topic</label>
                                                <input type="text" required="required" id="topic" placeholder="Enter conference topic" >
                                                ...
                                                <s:if test="#attr.GroupPost.get(#counter).type==2">
                                                    ...
                                                    <div>Attachment:   <s:property value="attachment"/>
                                                        <s:if test="attachment!=null">
                                                            <a href="<s:url value='/uploadedfiles/'/><s:property value="gid"/><s:property value="id"/><s:property value="attachment"/>" target="_blank"><i class="fa fa-file"></i></a>
                                                            </s:if>
                                                    </div>
                                                </s:if>
                        ...
                        <!--      
                                   ...
                                   To show all the members of the group               
                        -->
                        <div class="row" id="membersList" style="display:none;" >
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                                        ...
                                                        <s:if test="#attr.members.get(#cnt).userName != null">
                                                            <div class="w3-container col-sm-6">
                                                                <div class="w3-card-4">
                                                                    ...
                                                                    <div class="w3-container">
                                                                        <h4> <b> Role : </b> <span id="roleOfMember" style="color:blue;"><s:property value="#attr.members.get(#cnt).profileName"/>&nbsp;&nbsp;</span><s:if test='#attr.members.get(#cnt).profileId == 0 || #attr.members.get(#cnt).profileId == 1'><a onclick="showProfiles('<s:property value="profilesList"/>', '<s:property value="gid"/>', '<s:property value="#attr.members.get(#cnt).userId"/>');"><i class="fa fa-edit"></i></a></s:if></h4>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        </s:if>
                                                        ...
                                                        <div class="col-md-9 col-sm-9 col-xs-12">
                                                            <div class="row">
                                                                <s:iterator var="features" value="hashmap" status="incrementer">
                                                                    ...
                                                                    <li> 
                                                                        <span>
                                                                            <s:property value="key" /> <input type="checkbox" id="<s:if test='#va=="Video Chat"'>VideoChat</s:if><s:if test='#va!="Video Chat"'><s:property value='key'/></s:if>" value='<s:property value="key"/>'  name='<s:property value="key"/>'>  
                                                                            </span> 
                                                                        </li>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                                    ...
                                                                    <select id="selectBox2" class="form-control"  name="defaultProfile">
                                                                        ...
                                                                        <s:iterator value="profilesList">

                                                                            <option value="<s:property value='key' />" id="defaultProfileOption"><s:property value="value"/></option>
