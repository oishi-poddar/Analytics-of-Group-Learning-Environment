        ...
        <div class="container body">
            <div class="main_container">
                ...
                <div class="right_col" role="main">
                    ...
                    <%    if (session.getAttribute("updateAssignment") == "success") {
                            session.setAttribute("updateAssignment", null);    %>

                    <div class="alert alert-success alert-dismissable fade in">
                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                        <strong>Success!</strong> You have successfully updated the assignment.
                    </div>                    
                    <%       }%>
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="x_panel">
                                ...
                                <div class="x_content">
                                    ...
                                    <form id="updateAssignment" style="display: inline;" data-parsley-validate class="form-horizontal form-label-left" action="updateAssignment1.html"  method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                                                <button type="submit" id="sub" name="sub" class="btn btn-success">UPDATE</button>
                                            </div>
                                        </div>
                                    </form>
