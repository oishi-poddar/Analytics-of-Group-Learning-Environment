...
<li id="resultshow"><a><i class="fa fa-key" aria-hidden="true"></i>Attended Conferences Detail</a></li>
<li id='average'><a><i class="fa fa-key" aria-hidden="true"></i>Organized Conference Detail</a></li>
<li id='graph'><a><i class="fa fa-key" aria-hidden="true"></i>Bar-Graph of topic vs no of Conferences/time devoted</a></li>
<li id='piechart'><a><i class="fa fa-key" aria-hidden="true"></i> Topic Wise Attendance Pie chart</a></li>
<br><br><hr>   
...
<div  class="toshow" style="display:none" id="div">
    ...
    <table id="logsdetails2" class="table table-striped table-bordered" style="border: 1px solid black;">
        ...
        <caption><strong>Conference Details Topic Wise</strong></caption>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <table id="logsdetails2" class="table table-striped table-bordered" style="border: 1px solid black;">
                    ...
                    <caption><strong>Organised Conferences</strong></caption>
...
<div id="conferenceDetails" class="modal modal-wide fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title">Organised Conference Details</h4>
            </div>
            <div class="modal-body">
    ...
    <div style="display: none" id="chart">
        ...
        <div class="dropdown" style="margin-left: 14%;">
            ...
            <s:iterator status="averageConference" value="averageConference">
                <option onclick="setValues(this.value, '<s:property value="attendance" />');" value="<s:property value="topic" />"><s:property value="topic" /></option>
                </s:iterator>
        </div>
    </div>
