...
<!--<div id="UserDetails" class="modal fade toshow" style="display:none">
...
<script>
                    ...
                    alert(data);
                        ...
                        for (var i = 0; i < data.length; i++) {
                            ...
                            //dataTable.api().row.add([data[i][li[0]], data[i][li[1]], data[i][li[2]]]).draw();
                            alert(data[i][li[0]]+" "+data[i][li[1]]+" "+data[i][li[2]]);
                        }
