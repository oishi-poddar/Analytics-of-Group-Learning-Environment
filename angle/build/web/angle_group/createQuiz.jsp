<%-- 
    Document   : createQuiz
    Created on : 2 Jun, 2017, 9:58:58 AM
    Author     : pratik
--%>
    ...
    <body class="nav-md">
                    ...
                    <div class="row">
                        <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="x_panel">
                                ...
                                <p><input type="hidden" id="quiz_id" name="quiz_id" value="<s:property value="quizId"/>"/></p>
                                    ...
                                    <div id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="stitle" name="qtitle" required="required" class="form-control col-md-7 col-xs-12" value="">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Title On Successful Completion Of Quiz <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="successMsg" class="form-control" value="<s:property value="qsuccessTitle"/>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-md-3 col-sm-3 col-xs-12">Message On Successful Completion Of Quiz <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <textarea id="successContent" class="form-control" rows="3" placeholder=''><s:property value="qsuccessContent"/></textarea>
                                            </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input type="text" id="alerrorMsg" class="form-control" value="<s:property value="qerrorTitle"/>">
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <textarea id="errorContent" class="form-control" rows="3" placeholder=''><s:property value="qerrorContent"/></textarea>
                                            </div>
                                        ...
                                        <p id="qinformationError" style="display: none; color: red;">Please Fill Survey Information</p>
        ...
        <script type="text/javascript">
            ...
            function deleteQuestions(questionid) {
                var survey_id = document.getElementById("quiz_id").value;
            ...
            function saveSurvey() {
                ...
                if (qtitle.trim().length > 0 && (todayDate <= d1) && val == 0) {
                   // document.getElementById("stitle").style.border = "";
                    ...
                    document.getElementById("qinformationError").style.display = "none";
                    saveSurveyData(quizid, qtitle, d, success_title, error_title, success_msg, error_msg);
                } else {
            ...
            function saveSurveyData(qid, title, date, success_title, error_title, successMsg, errorMsg) {
                var data = "quizid=" + qid + "&qtitle=" + title + "&date=" + date + "&success_title="+success_title+"&error_title="+error_title+"&successMsg="+successMsg+"&errorMsg="+errorMsg;
                $.ajax({
                    url: "survey_module/pages/DAO_saveQuiz.jsp",
                    type: "GET",
                    data: data,
                    dataType: "json",
                    success: set_saveQuiz,
                    error: onError
                });
            }
