                                                    ...
                                                    <div class="w3-container col-sm-6">
                                                        <div class="w3-card-4">
                                                            ...
                                                            <div class="w3-container">
                                                                ...
                                                                <s:if test="#attr.group_list.get(#cnt).lockedState == 'Public'">
                                                                    <a href="#" onclick="joinGroupModal1('<s:property value="#attr.allGroups.get(#cnt).groupCode"/>');">Join</a>       
                                                                </s:if>


                                                                <s:if test="#attr.group_list.get(#cnt).lockedState == 'Private'">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3 col-sm-6 col-xs-12 ">
                                                            <div class="radio" id="radioButton">
                                                                <label>
                                                                    <input type="radio" checked="" value="1" id="PeerToPeer" name="g.groupType" class="flat" name="iCheck"> Peer To Peer
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-3 col-sm-6 col-xs-12">
                                                            <div class="radio">
                                                                <label>
                                                                    <input type="radio" value="2" id="MentorAndStudent" name="g.groupType" class="flat" name="iCheck">Mentor And Student
                                                                </label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-9 col-sm-6 col-xs-12">
                                                        <div class="row" style="margin-bottom: 5px;">
                                                            <div class="col-md-3">
                                                                <select id="sbOne" class="" name="" multiple="multiple" onclick="rights(this.value);" data-toggle="modal"  data-target="#rightsModal">
                                                                    <option value = "-1" id="profile" selected="">Select Profiles</option>s
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <select id="selectBox2" class="form-control" name="defaultProfile">
                                                                    <%--<s:property value="profile_list.size"/>--%>
                                                                    <option value = "-1" id="" selected="">Select default</option>
                                                                    <s:iterator value="profile_list">
                                                                        <option value="<s:property value='profileId' />" id="profile"><s:property value="profileName"/></option>
                                                                    </s:iterator>
                                                                </select>
